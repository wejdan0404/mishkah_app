...
class ReleasePressureLearnMoreScreen extends StatelessWidget {
  const ReleasePressureLearnMoreScreen({super.key});
      ...
      body: Directionality(
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              const AppTopNav(title: 'أطفئ الضغط'),
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                SvgPicture.asset(
                  AppSvgIcons.activitiesReleasePressure,
                  width: 80,
                  height: 80,
                ),
                const SizedBox(height: AppSpacing.xl),
                ...
                const SizedBox(height: AppSpacing.md),
                Text(
                  'هذا التمرين يساعدك تهدّي شدّك\nوتتنفّس ببطء حق يخف توترك.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: AppFontFamily.text,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'قبل ما تبدأ، خذ لحظة تهيئ نفسك فيها للتنفس بهدوء. اجلس براحة، رخِّ كتفيك، وخذ نفس عميق.',
