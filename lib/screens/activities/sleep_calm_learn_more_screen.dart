...
class SleepCalmLearnMoreScreen extends StatelessWidget {
  const SleepCalmLearnMoreScreen({super.key});
      ...
      body: Directionality(
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              const AppTopNav(title: 'نام بهدوء'),
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                SvgPicture.asset(
                  AppSvgIcons.activitiesSleepCalm,
                  width: 80,
                  height: 80,
                ),
                const SizedBox(height: AppSpacing.xl),
                ...
                const SizedBox(height: AppSpacing.md),
                Text(
                  'هذا التمرين يساعدك تهيّئ جسمك للنوم،\nوتهدّي ذهنك قبل ما تنام.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: AppFontFamily.text,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'قبل ما تبدأ، اختر مكانًا مريحًا بإضاءة خفيفة وأبعد ما يشتتك. ثم اتبع الإيقاع ببطء، وخذ وقتك بدون استعجال.',
